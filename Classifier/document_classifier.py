...
def classify_documents_in_folder(input_folder, output_folder):
    ...
    for file_name in os.listdir(input_folder):
        if file_name.endswith(".txt"):
            ...
            # ✨ MAS-compatible output structure
            mas_result = {
                ...
                "file_extension": "application/pdf",  # Assuming converted/uploaded as PDF
            ...
            # Save MAS-compatible JSON output
            with open(output_path, "w", encoding="utf-8") as f:
                json.dump(mas_result, f, indent=4)

            # OPTIONAL: Save raw classification if needed (for debug/audit)
